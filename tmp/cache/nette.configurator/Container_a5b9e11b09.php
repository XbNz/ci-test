...
class Container_a5b9e11b09 extends _PHPStan_ac6dae9b0\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService062(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_a5b9e11b09 $container)
			{
	...
	public function createServiceContainer(): Container_a5b9e11b09
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'PHP_INI_SCAN_DIR' => '',
				'PHPRC' => '/private/var/folders/d7/sxc05991099dggy26xw9pdh00000gn/T/h70t3i8vtehk9e7Ih14',
				'XDEBUG_HANDLER_SETTINGS' => '/private/var/folders/d7/sxc05991099dggy26xw9pdh00000gn/T/h70t3i8vtehk9e7Ih14|1|*|*|/opt/homebrew/etc/php/8.4/php.ini:/opt/homebrew/etc/php/8.4/conf.d/20-pcov.ini:/opt/homebrew/etc/php/8.4/conf.d/20-xdebug.ini:/opt/homebrew/etc/php/8.4/conf.d/80-redis.ini:/opt/homebrew/etc/php/8.4/conf.d/error_log.ini:/opt/homebrew/etc/php/8.4/conf.d/ext-opcache.ini:/opt/homebrew/etc/php/8.4/conf.d/php-memory-limits.ini|3.4.3',
			],
		];
	}
